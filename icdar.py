...
tf.app.flags.DEFINE_string('training_data_path', '/userapps/hdp/SVALTHDP/idp/datasets/ch4_training_images/',
...
def get_batch(num_workers, **kwargs):
    try:
        ...
        enqueuer.start(max_queue_size=2, workers=num_workers)
